        ...
        <div className="max-w-5xl mx-auto">
          <Tabs defaultValue="edit" className="w-full">
            <TabsList className="bg-[#1a1a1a] mb-6">
              <TabsTrigger value="edit" className="data-[state=active]:bg-[#8c8c91]/30">
                编辑
              </TabsTrigger>
              <TabsTrigger value="preview" className="data-[state=active]:bg-[#8c8c91]/30">
                预览
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="edit" className="space-y-6">
              ...
              <div>
                <Input
                  ...
                  className="bg-transparent border-[#8c8c91]/30 text-3xl font-light placeholder:text-[#8c8c91]/50 h-16 focus:border-[#8c8c91]"
                />
              </div>
              ...
              <div>
                ...
                {coverImage ? (
                  <div className="relative group aspect-[21/9] rounded-lg overflow-hidden bg-[#1a1a1a]">
                    <img
                      src={coverImage}
                      alt="Cover"
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="bg-transparent text-[#f0f0f0] hover:bg-[#f0f0f0] hover:text-[#050505]"
                      >
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="bg-transparent text-red-400 hover:bg-red-500 hover:text-white"
                      >
                        <X className="w-5 h-5" />
                      </Button>
                    </div>
              ...
              <div>
                ...
                <Input
                  ...
                  className="bg-transparent border-[#8c8c91]/30 text-[#f0f0f0] placeholder:text-[#8c8c91]/50 focus:border-[#8c8c91]"
                />
              </div>
                ...
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  {tags.map((tag) => (
                    <Badge
                      key={tag}
                      variant="secondary"
                      className="bg-[#1a1a1a] text-[#f0f0f0] hover:bg-[#8c8c91]/30 flex items-center gap-1"
                    >
                      {tag}
                      <button
            ...
            <TabsContent value="preview">
              <div className="bg-[#1a1a1a] rounded-lg p-8 min-h-[600px]">
            ...
            {drafts.length === 0 ? (
              ...
              drafts.map((draft) => (
                <div
                  ...
                  className="p-4 bg-[#050505] rounded-lg cursor-pointer hover:bg-[#050505]/80 transition-colors"
                >
